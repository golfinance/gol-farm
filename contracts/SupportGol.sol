...
contract SupportGol {
    ...
    // Info of each user.
    struct UserInfo {
        uint256 amount;   // How many GBALL tokens the user has provided.
        ...
        //
        // Whenever a user deposits or withdraws GBALL tokens to a pool. Here's what happens:
    ...
    // Info of each user that stakes GBALL tokens.
    ...
    // Deposit GBALL tokens to SupportGol for Reward allocation.
    ...
    // Withdraw GBALL tokens from SupportApe.
